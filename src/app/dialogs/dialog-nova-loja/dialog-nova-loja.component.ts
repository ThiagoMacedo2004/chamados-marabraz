...
@Component({
  selector: 'app-dialog-nova-loja',
  templateUrl: './dialog-nova-loja.component.html',
  styleUrls: ['./dialog-nova-loja.component.css']
})
export class DialogNovaLojaComponent implements OnInit {
  ...
  constructor(
    ...
    private _dialogRef: MatDialogRef<DialogNovaLojaComponent>,
  ) { }
  ...
  adicionarLoja() {
    ...
    this._service.adicionarLoja(JSON.stringify(obj)).subscribe(
      (result:any) => {
        if(result.sucesso) {
